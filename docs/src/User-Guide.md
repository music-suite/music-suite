...
The [Inspectable][ref-Inspectable] class represents types that can be converted into a standard musical representation and exported to one *output backend*. The top-level music expression in a file needs to be inspectable.
