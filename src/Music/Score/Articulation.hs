...
accent      :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
marcato     :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
accentAll   :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
marcatoAll  :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
accentLast  :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
marcatoLast :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
...
tenuto      :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
separated   :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
staccato    :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
portato     :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
legato      :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
spiccato    :: (HasEvents t d s a, HasPart' a, HasArticulation a) => s a -> s a
