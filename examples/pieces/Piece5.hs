...
>>> :o scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,e,g] [gs',ds'',_8va a'']) [x/12|x<-[0..25]]
>>> :au scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,e,g] [gs',ds'',_8va a'']) [x/12|x<-[0..25]]
...
<interactive>:1081:10:
    No instance for (Monoid s0) arising from a use of ‘scat’
    The type variable ‘s0’ is ambiguous
    Note: there are several potential instances:
...
>>> :pl scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,e,g] [gs',ds'',_8va a'']) [x/12|x<-[0..25]]
^CExitFailure 1
>>> 
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,e,g] [gs',ds'',_8va a'']) [x/12|x<-[0..25]]
ExitSuccess
>>> 
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] [fs,cds']) [x/12|x<-[0..25]]
...
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] [fs,c',as']) [x/12|x<-[0..25]]
^CExitFailure 1
>>> 
>>> :o set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] [fs,c',as']) [x/12|x<-[0..25]]
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] [fs,c',as']) [x/12|x<-[0..25]]
^CExitFailure 1
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] (_15va[fs,c',as'])) [x/12|x<-[0..25]]
^CExitFailure 1
>>> 
>>> :o set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] (_15va[fs,c',as'])) [x/12|x<-[0..25]]
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] (_15va[fs,c',as'])) [x/12|x<-[0..25]]
^CExitFailure 1
>>> 
>>> :pl set parts' violins $ scat $ map (pcat.map fromPitch'') $ _15vb $ fmap (interpPitches [c,g,e'] (_15va[fs,c',as'])) [x/12|x<-[0..25]]
